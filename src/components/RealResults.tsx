...
const RealResults = () => {
  ...
  const performanceStats = [
    { label: 'Student Success Rate', value: '87%', icon: <Trophy className="w-5 h-5" /> },
    { label: 'Average Monthly Return', value: '+12.4%', icon: <TrendingUp className="w-5 h-5" /> },
    { label: 'Strategies Deployed', value: '500+', icon: <Target className="w-5 h-5" /> },
    { label: 'Active Trading Bots', value: '1,200+', icon: <BarChart3 className="w-5 h-5" /> },
  ];
            ...
            <TabsContent value="code" className="space-y-8">
              ...
              <Card className="p-6 bg-card/50 backdrop-blur-sm">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <Badge variant="secondary" className="bg-yellow-500/10 text-yellow-500">Live Account</Badge>
                </div>
                <img 
