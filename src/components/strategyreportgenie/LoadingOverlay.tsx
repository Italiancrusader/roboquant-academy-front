...
const LoadingOverlay: React.FC<LoadingOverlayProps> = ({ message }) => {
  return (
    <div className="fixed inset-0 bg-background/80 backdrop-blur-sm flex items-center justify-center z-50">
      <div className="bg-card border border-border rounded-lg p-8 shadow-lg text-center space-y-5 max-w-md w-full mx-4">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-2 break-words max-w-full overflow-hidden">
